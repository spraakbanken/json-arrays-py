...
def test_streaming(infile, outfile, dump_kwargs):
    json_streams.dump_to_file(json_streams.load_from_file(infile), outfile, **dump_kwargs)
...
class TestLoadFromFile:
    def test_behaves_same_for_json_and_jsonl(self) -> None:
        ...
        loaded_from_json_lines = list(json_streams.load_from_file("tests/data/array.jsonl"))
